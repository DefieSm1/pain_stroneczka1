...
<div class="delta-container table-data">
    ...
    <form action="?" method="post" class="edit-form">
        ...
        <h1>Dodaj krotkę</h1>
        <h4 style="text-align: center; color: whitesmoke">Puste pole oznacza wartość domyślną... albo błąd ;)</h4>
        <?php 
        ...
        <button type="submit" class="button" name="isSubmitted" value="true">Dodaj<br>(przynajmniej spróbuj)</button>
    </form>
